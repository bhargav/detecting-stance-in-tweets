The trial data can be used for training.

The trial data file has the following format:
<ID><tab><Target><tab><Tweet><tab><Stance>

where
<ID> is an internal identification number;
<Target> is the entity of interest (e.g., "Hillary Clinton" or "Legalization of Abortion"; there will be more targets in the training data);
